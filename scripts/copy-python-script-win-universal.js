...
/**
 * Pythonスクリプトとランチャーをアプリケーションパッケージにコピーするスクリプト（Windows Universal用）
 * システム環境依存版
 */
...
function findOutputDirs() {
  console.log('Windows Universal用パッケージングディレクトリを検索中...');
...
// メイン処理
function main() {
  console.log('Windows Universal用Pythonスクリプトコピー処理を開始します...');
  ...
  console.log('Windows Universal用Pythonスクリプトのコピーが完了しました');
}
